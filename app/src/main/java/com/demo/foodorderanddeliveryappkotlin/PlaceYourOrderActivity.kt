...
class PlaceYourOrderActivity : AppCompatActivity() {
    ...
    private fun onPlaceOrderButtonCLick(restaurantModel: RestaurentModel?) {
        if(TextUtils.isEmpty(inputName.text.toString())) {
            ...
            inputCardPin.error =  "CVV giriniz"
            return
        }
